  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden font-sans selection:bg-white/30">
      ...
      <main className="relative z-10">
          ...
          <div className="container mx-auto max-w-6xl relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8 text-center lg:text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 max-w-2xl mx-auto lg:mx-0">
                  {/* YouTube Metric */}
        ...
        <section className="relative px-6 py-32 border-t border-white/5 bg-gradient-to-b from-black via-green-950/5 to-black overflow-hidden">
          ...
          <div className="container mx-auto max-w-5xl relative z-10">
            <div className="relative bg-gradient-to-br from-green-500/10 via-black to-black border border-green-500/20 rounded-[3rem] p-12 md:p-16 overflow-hidden">
              {/* Decorative elements */}
              ...
              <div className="relative z-10 text-center max-w-3xl mx-auto">
                ...
                {/* Icon */}
                <div className="w-24 h-24 mx-auto mb-8 rounded-3xl bg-green-500/10 border border-green-500/20 flex items-center justify-center">
                ...
                <div className="inline-flex items-center gap-3 mb-8">
                  <div className="flex -space-x-3">
                    {[1, 2, 3, 4].map((i) => (
                      <div key={i} className="w-10 h-10 rounded-full bg-gradient-to-br from-green-400 to-green-600 border-2 border-black flex items-center justify-center text-white text-xs font-bold">
                        {i}
                      </div>
                    ))}
                  </div>
                  <span className="text-2xl font-bold text-white">800+</span>
                  <span className="text-lg text-neutral-400">membros ativos</span>
                </div>

                {/* Description */}
                <p className="text-xl text-neutral-300 font-light leading-relaxed mb-10 max-w-2xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-12">
                  {[
                    ...
                    <div key={idx} className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] transition-all">
                ...
                <a
                  ...
                  className="group inline-flex items-center justify-center gap-3 h-16 px-12 text-lg font-semibold bg-green-500 text-white rounded-full hover:bg-green-400 transition-all duration-300 hover:scale-105 shadow-[0_0_40px_rgba(34,197,94,0.3)] hover:shadow-[0_0_60px_rgba(34,197,94,0.5)]"
                >
